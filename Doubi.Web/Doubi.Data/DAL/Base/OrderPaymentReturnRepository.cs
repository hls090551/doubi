...
{
    public partial class OrderPaymentReturnRepository<T> : IRepository<T> where T : OrderPaymentReturn
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_payment_return where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("order_payment_return")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("paystatus",entity.Paystatus)
                        .Column("errorcode",entity.Errorcode)
                        .Column("errormsg",entity.Errormsg)
                        .Column("otherinfo",entity.Otherinfo)
                        .Column("payname",entity.Payname)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_payment_return")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("paystatus",entity.Paystatus)
                        .Column("errorcode",entity.Errorcode)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("order_payment_return")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("paystatus",entity.Paystatus)
                        .Column("errorcode",entity.Errorcode)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_payment_return WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_payment_return where " + fieldname + " = @" + fieldname)
