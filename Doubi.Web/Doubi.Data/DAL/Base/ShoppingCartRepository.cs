...
{
    public partial class ShoppingCartRepository<T> : IRepository<T> where T : ShoppingCart
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from shopping_cart where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("shopping_cart")
                        .Column("userid",entity.Userid)
                        .Column("pcid",entity.Pcid)
                        .Column("goodsname",entity.Goodsname)
                        .Column("quantity",entity.Quantity)
                        .Column("weigth",entity.Weigth)
                        .Column("price",entity.Price)
                        .Column("needshipping",entity.Needshipping)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("shopping_cart")
                        .Column("userid",entity.Userid)
                        .Column("pcid",entity.Pcid)
                        .Column("goodsname",entity.Goodsname)
                        .Column("quantity",entity.Quantity)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM shopping_cart WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM shopping_cart where " + fieldname + " = @" + fieldname)
