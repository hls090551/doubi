...
{
    public partial class PaymentCardRepository<T> : IRepository<T> where T : PaymentCard
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from payment_card where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("payment_card")
                        .Column("cardname",entity.Cardname)
                        .Column("facevalue",entity.Facevalue)
                        .Column("rate",entity.Rate)
                        .Column("detailid",entity.Detailid)
                        .Column("cardimg",entity.Cardimg)
                        .Column("position",entity.Position)
                        .Column("cardtype",entity.Cardtype)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("payment_card")
                        .Column("cardname",entity.Cardname)
                        .Column("facevalue",entity.Facevalue)
                        .Column("rate",entity.Rate)
                        .Column("detailid",entity.Detailid)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM payment_card WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM payment_card where " + fieldname + " = @" + fieldname)
