...
{
    public partial class OrderShippingRepository<T> : IRepository<T> where T : OrderShipping
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_shipping where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("order_shipping")
                        .Column("orderid",entity.Orderid)
                        .Column("userid",entity.Userid)
                        .Column("shipping_status",entity.Shipping_status)
                        .Column("consignee",entity.Consignee)
                        .Column("mobile",entity.Mobile)
                        .Column("province",entity.Province)
                        .Column("city",entity.City)
                        .Column("country",entity.Country)
                        .Column("address",entity.Address)
                        .Column("goods_name",entity.Goods_name)
                        .Column("shippingid",entity.Shippingid)
                        .Column("best_time",entity.Best_time)
                        .Column("shippingfee",entity.Shippingfee)
                        .Column("delivery_sn",entity.Delivery_sn)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_shipping")
                        .Column("orderid",entity.Orderid)
                        .Column("userid",entity.Userid)
                        .Column("shipping_status",entity.Shipping_status)
                        .Column("consignee",entity.Consignee)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_shipping WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_shipping where " + fieldname + " = @" + fieldname)
