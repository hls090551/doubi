...
{
    public partial class ProductRepository<T> : IRepository<T> where T : Product
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from product_product where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("product_product")
                        .Column("pname",entity.Pname)
                        .Column("price",entity.Price)
                        .Column("vip_price",entity.Vip_price)
                        .Column("inventory",entity.Inventory)
                        .Column("need_kucun",entity.Need_kucun)
                        .Column("need_deliver",entity.Need_deliver)
                        .Column("type",entity.Type)
                        .Column("isonsale",entity.Isonsale)
                        .Column("pcode",entity.Pcode)
                        .Column("weight",entity.Weight)
                        .Column("addtime",entity.Addtime)
                        .Column("pinyin",entity.Pinyin)
                        .Column("flpinyin",entity.Flpinyin)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("product_product")
                        .Column("pname",entity.Pname)
                        .Column("price",entity.Price)
                        .Column("vip_price",entity.Vip_price)
                        .Column("inventory",entity.Inventory)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("product_product")
                        .Column("pname",entity.Pname)
                        .Column("price",entity.Price)
                        .Column("vip_price",entity.Vip_price)
                        .Column("inventory",entity.Inventory)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM product_product WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM product_product where " + fieldname + " = @" + fieldname)
