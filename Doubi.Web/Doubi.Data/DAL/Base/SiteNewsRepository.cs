...
{
    public partial class SiteNewsRepository<T> : IRepository<T> where T : SiteNews
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from site_news where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("site_news")
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("site_news")
                        .Column("title",entity.Title)
                        .Column("body",entity.Body)
                        .Column("creator",entity.Creator)
                        .Column("image",entity.Image)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM site_news WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM site_news where " + fieldname + " = @" + fieldname)
