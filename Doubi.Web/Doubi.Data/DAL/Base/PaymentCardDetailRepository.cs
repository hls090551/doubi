...
{
    public partial class PaymentCardDetailRepository<T> : IRepository<T> where T : PaymentCardDetail
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from payment_card_detail where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("payment_card_detail")
                        .Column("cardnolength",entity.Cardnolength)
                        .Column("cardnopwd",entity.Cardnopwd)
                        .Column("cardname",entity.Cardname)
                        .Column("extrano",entity.Extrano)
                        .Column("extraid",entity.Extraid)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("payment_card_detail")
                        .Column("cardnolength",entity.Cardnolength)
                        .Column("cardnopwd",entity.Cardnopwd)
                        .Column("cardname",entity.Cardname)
                        .Column("extrano",entity.Extrano)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("payment_card_detail")
                        .Column("cardnolength",entity.Cardnolength)
                        .Column("cardnopwd",entity.Cardnopwd)
                        .Column("cardname",entity.Cardname)
                        .Column("extrano",entity.Extrano)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM payment_card_detail WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM payment_card_detail where " + fieldname + " = @" + fieldname)
