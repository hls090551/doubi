...
{
    public partial class PaymentRepository<T> : IRepository<T> where T : Payment
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from payment_payment where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("payment_payment")
                        .Column("paycode",entity.Paycode)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("payment_payment")
                        .Column("paycode",entity.Paycode)
                        .Column("payname",entity.Payname)
                        .Column("position",entity.Position)
                        .Column("enable",entity.Enable)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("payment_payment")
                        .Column("paycode",entity.Paycode)
                        .Column("payname",entity.Payname)
                        .Column("position",entity.Position)
                        .Column("enable",entity.Enable)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM payment_payment WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM payment_payment where " + fieldname + " = @" + fieldname)
