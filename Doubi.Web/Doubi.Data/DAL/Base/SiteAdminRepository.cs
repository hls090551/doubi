...
{
    public partial class SiteAdminRepository<T> : IRepository<T> where T : SiteAdmin
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from site_admin where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("site_admin")
                        .Column("roleid",entity.Roleid)
                        .Column("adminname",entity.Adminname)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("site_admin")
                        .Column("roleid",entity.Roleid)
                        .Column("adminname",entity.Adminname)
                        .Column("password",entity.Password)
                        .Column("salt",entity.Salt)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM site_admin WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM site_admin where " + fieldname + " = @" + fieldname)
