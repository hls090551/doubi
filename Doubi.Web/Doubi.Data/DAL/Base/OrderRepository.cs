...
{
    public partial class OrderRepository<T> : IRepository<T> where T : Order
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_order where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("order_order")
                        .Column("userid",entity.Userid)
                        .Column("ordertotal",entity.Ordertotal)
                        .Column("goodname",entity.Goodname)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_order")
                        .Column("userid",entity.Userid)
                        .Column("ordertotal",entity.Ordertotal)
                        .Column("goodname",entity.Goodname)
                        .Column("type",entity.Type)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_order WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_order where " + fieldname + " = @" + fieldname)
