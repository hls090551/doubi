...
{
    public partial class UserMessageRepository<T> : IRepository<T> where T : UserMessage
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from user_message where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("user_message")
                        .Column("userid",entity.Userid)
                        .Column("content",entity.Content)
                        .Column("type",entity.Type)
                        .Column("isread",entity.Isread)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM user_message WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM user_message where " + fieldname + " = @" + fieldname)
