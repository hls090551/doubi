...
{
    public partial class ProductTypeRepository<T> : IRepository<T> where T : ProductType
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from product_type where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("product_type")
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("product_type")
                        .Column("type",entity.Type)
                        .Column("desc",entity.Desc)
                    .Where("Id",entity.Id)
                    .Execute() > 0;
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM product_type WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM product_type where " + fieldname + " = @" + fieldname)
