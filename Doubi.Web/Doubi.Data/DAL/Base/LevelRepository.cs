...
{
    public partial class LevelRepository<T> : IRepository<T> where T : Level
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from level_level where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("level_level")
                        .Column("viplevel",entity.Viplevel)
                        .Column("order_discount",entity.Order_discount)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("level_level")
                        .Column("viplevel",entity.Viplevel)
                        .Column("order_discount",entity.Order_discount)
                        .Column("desc",entity.Desc)
                    .Where("Id",entity.Id)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM level_level WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM level_level where " + fieldname + " = @" + fieldname)
