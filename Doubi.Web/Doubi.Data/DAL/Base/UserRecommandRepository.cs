...
{
    public partial class UserRecommandRepository<T> : IRepository<T> where T : UserRecommand
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from user_recommand where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("user_recommand")
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("user_recommand")
                        .Column("userid",entity.Userid)
                        .Column("reco_userid",entity.Reco_userid)
                        .Column("totalcontribute",entity.Totalcontribute)
                        .Column("createtime",entity.Createtime)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM user_recommand WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM user_recommand where " + fieldname + " = @" + fieldname)
