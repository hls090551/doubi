...
{
    public partial class UserAccountRepository<T> : IRepository<T> where T : UserAccount
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from user_account where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("user_account")
                        .Column("userid",entity.Userid)
                        .Column("balance",entity.Balance)
                        .Column("paypassword",entity.Paypassword)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("user_account")
                        .Column("userid",entity.Userid)
                        .Column("balance",entity.Balance)
                        .Column("paypassword",entity.Paypassword)
                        .Column("salt",entity.Salt)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM user_account WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM user_account where " + fieldname + " = @" + fieldname)
