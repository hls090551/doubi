...
namespace Doubi.Data.DAL
{
    public partial class OrderChargeDoubiRepository<T> : IRepository<T> where T : OrderCharge
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_charge_doubi where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_charge_doubi WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_charge_doubi where " + fieldname + " = @" + fieldname)
