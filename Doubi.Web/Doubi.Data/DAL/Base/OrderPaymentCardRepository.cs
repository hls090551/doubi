...
{
    public partial class OrderPaymentCardRepository<T> : IRepository<T> where T : OrderPaymentCard
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_payment_card where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("order_payment_card")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("pcardid",entity.Pcardid)
                        .Column("cardsn",entity.Cardsn)
                        .Column("cardpwd",entity.Cardpwd)
                        .Column("salt",entity.Salt)
                        .Column("amount",entity.Amount)
                        .Column("issubmit",entity.Issubmit)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_payment_card")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("pcardid",entity.Pcardid)
                        .Column("cardsn",entity.Cardsn)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("order_payment_card")
                        .Column("orderid",entity.Orderid)
                        .Column("opayid",entity.Opayid)
                        .Column("pcardid",entity.Pcardid)
                        .Column("cardsn",entity.Cardsn)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_payment_card WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_payment_card where " + fieldname + " = @" + fieldname)
