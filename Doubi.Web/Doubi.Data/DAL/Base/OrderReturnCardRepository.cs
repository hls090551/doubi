...
{
    public partial class OrderReturnCardRepository<T> : IRepository<T> where T : OrderReturnCard
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_return_card where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_return_card")
                        .Column("orderid",entity.Orderid)
                        .Column("userid",entity.Userid)
                        .Column("pcid",entity.Pcid)
                        .Column("cardsn",entity.Cardsn)
        ...
        public void UpdateWithTransaction(T entity, IDbContext context)
        {
            ...
            context.Update("order_return_card")
                        .Column("orderid",entity.Orderid)
                        .Column("userid",entity.Userid)
                        .Column("pcid",entity.Pcid)
                        .Column("cardsn",entity.Cardsn)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_return_card WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_return_card where " + fieldname + " = @" + fieldname)
