...
{
    public partial class UserRepository<T> : IRepository<T> where T : User
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from user_user where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("user_user")
                        .Column("username",entity.Username)
                        .Column("password",entity.Password)
                        .Column("salt",entity.Salt)
                        .Column("email",entity.Email)
                        .Column("mobile",entity.Mobile)
                        .Column("viplevel",entity.Viplevel)
                        .Column("isonline",entity.Isonline)
                        .Column("status",entity.Status)
                        .Column("createtime",entity.Createtime)
                        .Column("lastlogintime",entity.Lastlogintime)
                        .Column("recommanderid",entity.Recommanderid)
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("user_user")
                        .Column("username",entity.Username)
                        .Column("password",entity.Password)
                        .Column("salt",entity.Salt)
                        .Column("email",entity.Email)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM user_user WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM user_user where " + fieldname + " = @" + fieldname)
