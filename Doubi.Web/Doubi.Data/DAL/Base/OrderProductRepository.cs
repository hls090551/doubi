...
{
    public partial class OrderProductRepository<T> : IRepository<T> where T : OrderProduct
    {
        ...
        public T GetById(int id)
        {
            ...
            {
                T entity = context.Sql(@"select * from order_product where id=@id").Parameter("id", id).QuerySingle<T>();
                return entity;
            }
        }
      ...
      public bool Insert(T entity)
        {
            ...
            using (var context = Context())
            {
                int id = context.Insert("order_product")
        ...
        public bool Update(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Update("order_product")
                        .Column("orderid",entity.Orderid)
                        .Column("pcid",entity.Pcid)
                        .Column("quantity",entity.Quantity)
                        .Column("type",entity.Type)
        ...
        public bool Delete(T entity)
        {
            ...
            using (var context = Context())
            {
                return context.Sql(" DELETE FROM order_product WHERE id = @id ")
        ...
        public int CountByField(string fieldname, object fieldvalue)
        {
            using (var context = Context())
            {               
                return context.Sql(" SELECT COUNT(*) FROM order_product where " + fieldname + " = @" + fieldname)
